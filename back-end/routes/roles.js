...
router.get('/', isAuth, isAdmin, asyncHandler(async function (req, res, next) {
  ...
  #swagger.responses[500] = { description: 'This response is returned when **an internal server error** occurs while the API is trying to retrieve all roles', schema: {$ref: '#/definitions/rolesGetInternalError'}}
